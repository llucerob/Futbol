        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <form class="needs-validation theme-form" novalidate="" action="{{ route('store.club') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                          <div class="row g-3">
                          ...
                          <div class="row g-3">
                            <div class="col-md-6">
                              <div class="mb-3">
                                ...
                                <input class="datepicker-here form-control digits" required  data-lenguage="es" id="fundacion" type="text" name="f_fundacion" placeholder="12-01-1999">
                                <div class="valid-feedback">¡Luce bien!</div>
                              </div>
                            </div>
